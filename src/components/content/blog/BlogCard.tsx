    ...
    >
      ...
      >
        ...
        <div className={contentClasses}>
          ...
          <h3
            className={`${isFeatured ? "text-2xl lg:text-3xl" : "text-xl"} font-semibold mb-2 ${isFeatured ? "line-clamp-3" : "line-clamp-2"}`}
          >
            {post.title}
          </h3>
          <p
            className={`text-gray-600 dark:text-gray-300 ${isFeatured ? "text-base line-clamp-4" : "text-sm line-clamp-3"}`}
          >
            {post.excerpt}
          </p>
        </div>
